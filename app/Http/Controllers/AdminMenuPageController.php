...
class AdminMenuPageController extends Controller
{
    ...
    {
        $menuPage = MenuPage::first();

        return view('admin.menu-page.index', compact('menuPage'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.menu-page.index')->withToastSuccess('Updated Successfully');
