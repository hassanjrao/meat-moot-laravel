...
@section('content')
    ...
    <div class="container-fluid pt-5 theme">
                ...
                <div class="col-12 col-md-6">
                    <div class="d-flex text-light p-3 background-two mb-3"
                        ...
                        <div>
                            ...
                            <h5>
                                ...
                                Maxime, ullam hic veniam vero dicta voluptates eum ad atque
                                dignissimos deleniti quidem
                            </h5>
                        </div>
                    ...
                    <div class="d-flex text-light p-3 background-two mb-3"
                        ...
                        <div>
                            ...
                            <h5>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                Maxime, ullam hic veniam vero dicta voluptates eum
                            </h5>
                        </div>
                        <div class="line-effect"></div>
                        <!-- Line Effect  -->
        ...
        <div class="container">
            ...
            <div class="row box">
                <div class="col-12 col-md-4 bordered-right-bottom p-5">
                    <div class="p-3 text-center text-light">
                        <i class="fa-solid fa-bowl-food pt-3 px-2"></i>
                        <h4 class="menu">Ultimate Free Source</h4>
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Hic
                            eos esse unde distinctio recusandae modi laudantium ipsam? At,
                            quasi quia nisi recusandae sit voluptas
                        </p>
                    </div>
                </div>
                <div class="col-12 col-md-4 bordered-right-bottom p-5">
                    <div class="p-3 text-center text-light">
                        <i class="fa-solid fa-bowl-food pt-3 px-2"></i>
                        <h4 class="menu">Ultimate Salad and Apitizer</h4>
                        <p>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Hic
                            eos esse unde distinctio recusandae modi laudantium ipsam?
                        </p>
                    </div>
                </div>
                <div class="col-12 col-md-4 bordered-bottom p-5">
                    <div class="p-3 text-center text-light">
                        <i class="fa-solid fa-bowl-food pt-3 px-2"></i>
                        <h4 class="menu">Ultimate Free rice</h4>
            ...
            <div class="row box">
                <div class="col-12 col-md-4 p-5 bordered-right-bottom">
                    <div class="p-3 text-center text-light">
                        <i class="fa-solid fa-bowl-food pt-3 px-2"></i>
                        <h4 class="menu">unlimited beverage</h4>
