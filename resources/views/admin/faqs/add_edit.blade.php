                    ...
                    <div class="col-lg-12 ">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 mb-4">
                                ...
                                ?>
                                <label class="form-label" for="label"> Question <span class="text-danger">*</span></label>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 mb-4">
                                ...
                                ?>
                                <label class="form-label" for="label"> Answer <span class="text-danger">*</span></label>

                                <textarea required class="form-control" id="answer" name="answer"
                                    placeholder="Enter Answer">{{ $value }}</textarea>
