...
@section('content')
    ...
    <div class="content content-boxed">
        ...
        <form action="{{ route('admin.contact-page.update', $contactPage->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="block-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-12 mb-4">
                            <?php
                            $value = old('hero_title', $contactPage ? $contactPage->hero_title : null);
                            ?>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 mb-4">
                            ...
                            @if ($contactPage && $contactPage->hero_bg_image)
                                <img src="{{ $contactPage->hero_bg_image_url }}" alt="image" class="img-fluid"
                                    style="width: 100px">
                                    <br>
